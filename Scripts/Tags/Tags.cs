...
public class Tags {
	...
	public static string BG_GAMEOBJECT = "Background";
	public static string GROUND_GAMEOBJECT = "Ground";
	...
	public static string BLOCKER_TAG = "Blocker";
	...
	//public static string ANIMATION_LAND = "Land";
}
